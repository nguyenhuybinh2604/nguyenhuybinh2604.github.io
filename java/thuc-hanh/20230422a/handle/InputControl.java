...
public class InputControl {
    ...
    public String getString(Scanner sc ,String typeOfValue) {
        System.out.println("Nhap gia tri cho " + typeOfValue + " :");
        String returnValue = sc.nextLine();
        while (returnValue==null || returnValue.equals("")) {
            System.out.println("Nhap lai gia tri cho " + typeOfValue + ". Yeu cau khong duoc trong:");
